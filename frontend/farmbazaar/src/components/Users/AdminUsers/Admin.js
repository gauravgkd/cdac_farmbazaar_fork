        ...
        <div className="col">
          <div className="card" style={{ width: '18rem' }}>
            <div className="card-body">
              ...
              <Link to="admin/admin-users" className="btn btn-primary">Go to Admin Users</Link>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card" style={{ width: '18rem' }}>
            <div className="card-body">
              ...
              <Link to="/admin/customer-users" className="btn btn-primary">Go to Customer Users</Link>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card" style={{ width: '18rem' }}>
            <div className="card-body">
              ...
              <Link to="/admin/delivery-partner-users" className="btn btn-primary">Go to Delivery Partner Users</Link>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card" style={{ width: '18rem' }}>
            <div className="card-body">
              ...
              <Link to="admin/farmer-users" className="btn btn-primary">Go to Farmer Users</Link>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card" style={{ width: '18rem' }}>
            <div className="card-body">
              ...
              <Link to="/admin/categories" className="btn btn-primary">Go to Categories</Link>
            </div>
          </div>
        </div>
        <div className="col">
        ...
        <div className="col">
          <div className="card" style={{ width: '18rem' }}>
            <div className="card-body">
              ...
              <Link to="/admin/assign-product-to-farmer" className="btn btn-primary">Go to Assign Product to Farmer</Link>
            </div>
          </div>
        </div>
      </div>
